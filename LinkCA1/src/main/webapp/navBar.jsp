				...
				<a href="./Home.jsp"
					...
					<div id="dropdownHover"
						...
						<form action="<%=request.getContextPath()%>/DisplayItems"
							class="text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex gap-1 items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 justify-center w-full">
							...
							</button class="text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex gap-1 items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 justify-center w-full">
						</form>
					</div>
